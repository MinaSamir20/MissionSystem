...
namespace MissionSystem.Infrastructure.Services
{
    public class AuthService : IAuthService 
    {
        ...
        public AuthService(AppDbContext db, UserManager<User> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, IWebHostEnvironment web)
        {
            _db = db;
