    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GovernmentNameAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GovernmentNameEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GmailAccount = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Coordinators_Addresses_AddressId",
            ...
            migrationBuilder.CreateTable(
                name: "CoordinatorMission",
                columns: table => new
                {
                    CoordinatorsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoordinatorMission", x => new { x.CoordinatorsId, x.MissionId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoordinatorMission_Missions_MissionId",
                        column: x => x.MissionId,
                        principalTable: "Missions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schools_Coordinators_CoordinatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissionSchool", x => new { x.MissionId, x.SchoolId });
                    table.ForeignKey(
                        name: "FK_MissionSchool_Missions_MissionId",
                        column: x => x.MissionId,
                        principalTable: "Missions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MissionSchool_Schools_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoordinatorMission_MissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionSchool_SchoolId",
                table: "MissionSchool",
                column: "SchoolId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schools_CoordinatorId_AddressId",
                table: "Schools",
                columns: new[] { "CoordinatorId", "AddressId" },
                unique: true);
